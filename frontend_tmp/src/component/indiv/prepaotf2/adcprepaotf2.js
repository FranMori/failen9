...
axios.get(getAll).then (res => {
  ...
  for (let i = 0; i < games; i++) {
    ...
    // Gold Diff @ 8
    let goldDiff_8 = parseInt(((res.data[i]).GoldDiff4_8))
    GoldDiff_8Tot += goldDiff_8
    // Gold Diff @ 14
    let goldDiff_14 = parseInt(((res.data[i]).GoldDiff4_14))
    GoldDiff_14Tot += goldDiff_14
    // Gold Diff @ 22
    let goldDiff_22 = parseInt(((res.data[i]).GoldDiff4_22))
...
export default StatsPrepaotf2Adc