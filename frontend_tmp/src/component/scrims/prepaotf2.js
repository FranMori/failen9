...
const getBlue = 'http://localhost:5000/api/team/prepaotf2/getBlue'
const getRed = 'http://localhost:5000/api/team/prepaotf2/getRed'


const getWinrate = 'http://localhost:5000/api/team/prepaotf2/getWinrate'
const getWinrateBlue = 'http://localhost:5000/api/team/prepaotf2/getWinrateBlue'
const getWinrateRed = 'http://localhost:5000/api/team/prepaotf2/getWinrateRed'

const getDrake = 'http://localhost:5000/api/team/prepaotf2/getDrake'
const getDrakeBlue = 'http://localhost:5000/api/team/prepaotf2/getDrakeBlue'
const getDrakeRed = 'http://localhost:5000/api/team/prepaotf2/getDrakeRed'


const getHerald = 'http://localhost:5000/api/team/prepaotf2/getHerald'
const getHeraldBlue = 'http://localhost:5000/api/team/prepaotf2/getHeraldBlue'
const getHeraldRed = 'http://localhost:5000/api/team/prepaotf2/getHeraldRed'

export function Prepaotf2Stats() {
...
class Prepaotf2 extends Component {
  state = {
    prepaotf2: [],
  }
 ...
 constructor() {
   super()
  axios.get(getAll).then(res => {
    this.setState({prepaotf2 : res.data})
...
<div className='scrim'>
      <Header />
      <h1 className='titrePeriode'>Prépa OTF2</h1>
      <nav>
        <Button variant="warning"><Link to = "/team/prepaotf2/top">Top</Link></Button>
        <Button variant="warning"><Link to = "/team/prepaotf2/jungle">Jungle</Link></Button>
        <Button variant="warning"><Link to = "/team/prepaotf2/mid">Mid</Link></Button>
        <Button variant="warning"><Link to = "/team/prepaotf2/adc">Adc</Link></Button>
        <Button variant="warning"><Link to = "/team/prepaotf2/support">Support</Link></Button>

      </nav>
      <Prepaotf2Stats />
      <div className='addScrim'>
        <Button variant="warning"><Link to = "/team/add">Add Scrim</Link></Button>
        <Outlet />
      </div>
      
     <div className='coreScrim'>
     {this.state.prepaotf2.map((val, key) => {
